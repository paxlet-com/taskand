#!/usr/bin/env node
// proc://taskand.dev/vault/spawn/v1 — Protokół powoływania organizmów (peer-to-peer spawn)
...
metadata:
  ...
  version: "1.0.0"
  description: "Autonomiczny organizm ${targetOrg} powołany przez taskand-vault"
spec:
  role: ${role}
  processes:
