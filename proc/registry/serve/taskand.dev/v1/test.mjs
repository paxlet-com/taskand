...
// Test 2: Poprawne zapytanie o katalog -> exit 0
const good = spawnSync('node', [join(dir, 'bin.mjs')], { input: JSON.stringify({ action: "catalog" }) });
if (good.status !== 0) {
...
console.log('proc://taskand.dev/registry/serve/v1: kontrakt ✓');
